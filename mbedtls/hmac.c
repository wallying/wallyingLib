...
int hmac_sha1_setup( hmac_sha1_context_t *ctx, int32_t hmac )
{
    return( 0 );
}
...
int hmac_sha1_update( hmac_sha1_context_t *ctx, const uint8_t *input, uint32_t ilen )
{
...
int hmac_sha1_finish( hmac_sha1_context_t *ctx, uint8_t *output )
{
...
int hmac_sha1_reset( hmac_sha1_context_t *ctx )
{
    mbedtls_sha1_starts( (mbedtls_sha1_context *) ctx->md_ctx);
    mbedtls_sha1_update( (mbedtls_sha1_context *) ctx->md_ctx, ctx->ipad, SHA1_BLOCK_SIZE );
...
int hmac_sha1_crypt( const uint8_t *key, uint32_t keylen, const uint8_t *input, uint32_t ilen, uint8_t *output )
{
...
int hmac_sha256_setup( hmac_sha256_context_t *ctx, int32_t hmac )
{
    return( 0 );
}
...
int hmac_sha256_update( hmac_sha256_context_t *ctx, const uint8_t *input, uint32_t ilen )
{
    mbedtls_sha256_update( (mbedtls_sha256_context *) ctx->md_ctx, input, ilen );
    return( 0 );
}

int hmac_sha256_finish( hmac_sha256_context_t *ctx, uint8_t *output )
{
...
int hmac_sha256_reset( hmac_sha256_context_t *ctx )
{
    mbedtls_sha256_starts( (mbedtls_sha256_context *) ctx->md_ctx , 0);
    mbedtls_sha256_update( (mbedtls_sha256_context *) ctx->md_ctx, ctx->ipad, SHA256_BLOCK_SIZE );
...
int hmac_sha256_crypt( const uint8_t *key, uint32_t keylen, const uint8_t *input, uint32_t ilen, uint8_t *output )
{
...
int sha256_hkdf( const uint8_t *key, uint32_t key_len,
