...
#define MBEDTLS_AES_ROM_TABLES //wallying
// #define MBEDTLS_AES_FEWER_TABLES //wallying

#define MBEDTLS_AES_C //wallying

#if defined(MBEDTLS_AES_C)

#include <string.h>

// #include "mbedtls/aes.h" //wallying
#include "aes.h"

// #include "mbedtls/platform.h" //wallying

// #include "mbedtls/platform_util.h" //wallying
/* Internal macros meant to be called only from within the library. */
#define MBEDTLS_INTERNAL_VALIDATE_RET( cond, ret )  do { } while( 0 )
#define MBEDTLS_INTERNAL_VALIDATE( cond )           do { } while( 0 )

// #include "mbedtls/error.h" //wallying
/** Generic error */
#define MBEDTLS_ERR_ERROR_GENERIC_ERROR       -0x0001
/** This is a bug in the library */
#define MBEDTLS_ERR_ERROR_CORRUPTION_DETECTED -0x006E

static void mbedtls_platform_zeroize( void *buf, size_t len ) //wallying
{
